...
const Column: React.FC<Column> = ({ columnId, title, tickets, setTickets, triggerTicketModal, settings }) => {
  ...
  return (
    <div ref={drop} className={`flex flex-col items-center flex-shrink-0 w-[270px]  bg-primary-300 dark:bg-primary-800 p-1 pb-3 mx-2 my-2 md:my-0 rounded-md ${isOver ? 'opacity-50' : 'opacity-100'} drop-shadow-sm`}>
