...
">
        ...
        <div className="text-[9px] text-white font-light pb-2">{content.length > settings.tickets.ticketPreviewLength ? `${content.substring(0, settings.tickets.ticketPreviewLength)}...` : content}</div>
      </Link>
    </li>
  );
};
