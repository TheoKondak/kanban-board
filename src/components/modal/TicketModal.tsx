  ...
  return (
    <>
      {tickets.length === 0 ? (
        ...
        <>
          <div className={`ticket-modal fixed inset-0 bg-primary-900/50 dark:bg-primary-900/70 ${isTicketModalVisible ? 'opacity-100 backdrop-blur-sm' : 'pointer-events-none opacity-0'}`} onClick={closeModal}></div>
